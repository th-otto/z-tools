...
#if 0
void __CDECL ca_decompress(const uint8_t *filedata, uint8_t *screen) ASM_NAME("ca_decompress");
#else

__attribute__((noinline))
static void __CDECL ca_decompress(const uint8_t *filedata, uint8_t *screen)
{
	uint8_t *dst;
	uint8_t *end;
	uint8_t esc;
