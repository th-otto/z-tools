...
struct SVGTextPosition {
    SVGTextPosition(const SVGNode* _node, size_t _startOffset, size_t _endOffset)
        : node(_node), startOffset(_startOffset), endOffset(_endOffset)
    {}
...
struct SVGTextFragment {
    explicit SVGTextFragment(const SVGTextPositioningElement* _element) : element(_element) {}
