...
public:
    ...
    constexpr Point(float _x, float _y) : x(_x), y(_y) {}
...
public:
    ...
    constexpr Size(float _w, float _h) : w(_w), h(_h) {}
...
public:
    ...
    constexpr Rect(float _x, float _y, float _w, float _h) : x(_x), y(_y), w(_w), h(_h) {}
