...
void plutovg_matrix_map_points(const plutovg_matrix_t *matrix, const plutovg_point_t *src, plutovg_point_t *dst,
	plutovg_int_t count)
{
	plutovg_int_t i;
...
bool plutovg_matrix_parse(plutovg_matrix_t *matrix, const char *data, plutovg_int_t length)
{
	float values[6];
	const char *it;
	const char *end;
