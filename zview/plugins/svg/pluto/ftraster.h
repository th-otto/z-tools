...
{
	PVG_FT_Int n_contours;				/* number of contours in glyph        */
	PVG_FT_Int n_points;				/* number of points in the glyph      */

	PVG_FT_Vector *points;				/* the outline's points               */
	char *tags;							/* the points flags                   */
	PVG_FT_Int *contours;				/* the contour end points             */
	char *contours_flag;				/* the contour open flags             */

	PVG_FT_Int flags;					/* outline masks                      */
...
/*                                                                       */
typedef void (*PVG_FT_SpanFunc)(PVG_FT_Int count, const PVG_FT_Span *spans, void *user);
