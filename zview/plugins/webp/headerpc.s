...
slh_functions:
          ...
          .dc.l _wrap_encoder_init
          .dc.l _wrap_encoder_write
          .dc.l _wrap_encoder_quit
          .dc.l _wrap_get_option
          .dc.l _wrap_set_option
slh_fend:
  ...
  .dc.b 0
          name_encoder_init_str: .ascii "encoder_init"
  .dc.b 0
          name_encoder_write_str: .ascii "encoder_write"
  .dc.b 0
          name_encoder_quit_str: .ascii "encoder_quit"
  .dc.b 0
          name_get_option_str: .ascii "get_option"
  .dc.b 0
          name_set_option_str: .ascii "set_option"
  .dc.b 0
 .even
_slh_names:
          ...
          .dc.l name_encoder_init_str
          .dc.l name_encoder_write_str
          .dc.l name_encoder_quit_str
          .dc.l name_get_option_str
          .dc.l name_set_option_str
  ...
  move.l d0,4(a7)
  bra reader_quit
          _wrap_encoder_init: movem.l 16(a7),d0-d1
  movem.l d0-d1,4(a7)
  bra encoder_init
          _wrap_encoder_write: movem.l 16(a7),d0-d1
  movem.l d0-d1,4(a7)
  bra encoder_write
          _wrap_encoder_quit: move.l 16(a7),d0
  move.l d0,4(a7)
  bra encoder_quit
          _wrap_get_option: move.l 16(a7),d0
  move.l d0,4(a7)
  bra get_option
          _wrap_set_option: movem.l 16(a7),d0-d1
  movem.l d0-d1,4(a7)
  bra set_option
_slbname: .ascii "zvwebp.slb"
 .dc.b 0
 .even
